...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/docs/3.3.3.RELEASE/reference/htmlsingle/index.html#web.security.oauth2.authorization-server)
...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/3.3.3.RELEASE/reference/htmlsingle/index.html#io.webservices)
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.3.3.RELEASE/reference/htmlsingle/index.html#messaging.websockets)
